                ...
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('publications.update', $publication->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <span class="text-info">Leave empty to keep current thumbnail. Maximum size 100 MB. Supported formats: JPG, PNG, JPEG, GIF</span>
                            @error('thumbnail')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <span class="text-info">Leave empty to keep current PDF file. Maximum size 100 MB</span>
                            @error('pdf_file')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
